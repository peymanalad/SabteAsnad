...
public class PayaService {
    ...
    public void createPayaExcel() throws SQLException {
        ...
        PreparedStatement firstSumStatement = connection.prepareStatement(sumOf128Query);
        PreparedStatement secondSumStatement = connection.prepareStatement(sumOf61112Query);
