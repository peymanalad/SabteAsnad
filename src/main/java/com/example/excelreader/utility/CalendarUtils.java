...
public final class CalendarUtils {
  ...
  private static String getCurrentGregorianDateTimeImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale) {
    ULocale locale;
  ...
  private static String getCurrentGregorianDateTimeImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale, String pattern) {
    ULocale locale;
    if (calendarLocale == null) {
      locale = getGregorianCalendarULocale();
    } else {
  ...
  private static String getCurrentGregorianDateImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale) {
    ULocale locale;
    if (calendarLocale == null) {
      locale = getGregorianCalendarULocale();
  ...
  private static String getCurrentPersianDateTimeImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale, String pattern) {
    ULocale locale;
    if (calendarLocale == null) {
  ...
  private static String getCurrentPersianDateTimeImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale, String pattern, Calendar calendar) {
    ULocale locale;
    if (calendarLocale == null) {
      locale = getPersianCalendarULocale();
    } else {
  ...
  private static String getCurrentPersianDateImpl(
      com.sepehrnet.surplusfund.enums.CalendarEnum calendarLocale) {
    ULocale locale;
    if (calendarLocale == null) {
      locale = getPersianCalendarULocale();
